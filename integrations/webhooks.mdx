...
- Entrega: atualmente o envio é feito uma vez, com timeout de 10 segundos. Retorne `200` ou `204` e use o identificador do evento para manter o processamento idempotente.
...
<Warning>Webhooks exigem uma URL HTTPS pública. Endereços locais, redes privadas e redirecionamentos são bloqueados por segurança.</Warning>
